export const CURATED_FURNITURE_BY_TYPE = Object.freeze({
    ...
    tv: ['u_furniture_tv_wall_001_', 'u_furniture_camera_001_'],
    ...
    console: ['u_furniture_coffee_machine_001_', 'u_furniture_camera_001_'],
    freezer: ['u_furniture_washing_machine_001_', 'u_furniture_fridge_001_'],
    cd: ['u_furniture_dish_001_', 'u_furniture_dish_002_'],
    radio: ['u_furniture_musical_instrument_001_', 'u_furniture_camera_001_'],
    guitar: ['u_furniture_musical_instrument_001_'],
    clock: ['u_furniture_camera_001_'],
    ...
    mirror: [],
    rug: ['u_furniture_clothes_001_', 'u_furniture_clothes_002_'],
    piano: ['u_furniture_musical_instrument_001_'],
    microwave: ['u_furniture_microwave_oven_001_'],
    vase: ['u_furniture_flower_001_'],
});
